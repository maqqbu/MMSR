...
X=tdfread('../original_datasets/all_collected_data/disgust.standardized.tsv');
...
for F = 0 : 2 : 20
    ...
    for times = 1 : 3
        ...
        save_name = ['../corrupted_datasets/disgust/disgust_38_corruption_', num2str(F),'_', num2str(times), '.mat'];
