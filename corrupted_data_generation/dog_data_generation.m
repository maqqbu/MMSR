clc
clear all
crowd = load("../original_datasets/dog_crowd.txt");
truth = load("../original_datasets/dog_truth.txt");
task_ids = crowd(:, 1);
worker_ids = crowd(:, 2);
class_ids = crowd(:, 3);
truth_ids = truth(:, 1);
...
for F = 0 : 6 : 54
    ...
    for times = 1 : 3
        ...
        save_name = ['../corrupted_datasets/dog/dog_raw_corruption_', num2str(F),'_', num2str(times), '.mat'];
