...
gold_label_ids = string(T_mv.Q1ExpertVote);
...
Answer(:, 1) = string(T_non_experts.Answer_related1);
Answer(:, 2) = string(T_non_experts.Answer_related2);
Answer(:, 3) = string(T_non_experts.Answer_related3);
Answer(:, 4) = string(T_non_experts.Answer_related4);
...
for F = 0 : 10 : 90
    ...
    for times = 1 : 3
        ...
        save_name = ['../corrupted_datasets/fashion1/fashion1_raw_corruption_', num2str(F),'_', num2str(times), '.mat'];
